...
{
    public sealed class CreateCourseByAdminCommandValidator : AbstractValidator<CreateCourseByAdminCommand>
    {
        ...
        public CreateCourseByAdminCommandValidator()
        {
            ...
            RuleFor(x => x.Slug)
                ...
                .WithMessage("آدرس دوره باید شامل حروف کوچک، اعداد و خط‌تیره باشد.");
        ...
        private sealed class FileValidator(
            ...
            : PropertyValidator<CreateCourseByAdminCommand, IFile?>
        {
            public override string Name => nameof(FileValidator);

            public override bool IsValid(ValidationContext<CreateCourseByAdminCommand> context, IFile? value)
            {
                if (value is null)
                    return true;
