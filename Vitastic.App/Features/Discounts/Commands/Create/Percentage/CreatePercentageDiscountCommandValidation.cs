...
{
    public sealed class CreatePercentageDiscountCommandValidation : AbstractValidator<CreatePercentageDiscountCommand>
    {
        public CreatePercentageDiscountCommandValidation()
        {
            RuleFor(x => x.Code)
            ...
            RuleFor(x => x.Percentage)
                ...
                .WithMessage("درصد تخفیف باید بین ۰.۰۱ تا ۱۰۰ باشد.");
