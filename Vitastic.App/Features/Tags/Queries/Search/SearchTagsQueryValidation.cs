...
public sealed class SearchTagsQueryValidation : AbstractValidator<SearchTagsQuery>
{
    public SearchTagsQueryValidation()
    {
        When(s => !string.IsNullOrWhiteSpace(s.SearchTerm), () =>
        {
